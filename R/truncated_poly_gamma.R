...
#' }
#' @export
bi.dist.truncated_polya_gamma=function(batch_shape=c(), validate_args=py_none(), name='x', obs=py_none(), mask=py_none(), sample=FALSE, seed = py_none(), shape=c(), event=0, create_obj=FALSE) {
